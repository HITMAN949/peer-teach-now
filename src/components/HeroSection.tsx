        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
              Learn from peers.<br />
              <span className="text-westudy-600">Teach what you know.</span>
            </h1>
          ...
          <div className="order-1 md:order-2">
            <div className="relative">
              <div className="absolute top-0 -left-4 w-72 h-72 bg-westudy-200 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-float"></div>
              <div className="absolute -bottom-8 right-4 w-72 h-72 bg-westudy-blue-200 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-float animation-delay-2000"></div>
              <div className="absolute -top-4 right-20 w-72 h-72 bg-westudy-green-200 rounded-full mix-blend-multiply filter blur-2xl opacity-70 animate-float animation-delay-4000"></div>
              <div className="relative">
                <div className="rounded-2xl bg-white shadow-xl p-2 md:p-4 relative z-10">
                  <img
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-lg shadow-lg p-4 z-20">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium">300+ students</p>
